                ...
                <div style="border:1px solid #e8e9f2;border-radius:12px;overflow:hidden;">
                    ...
                    <label style="display:flex;align-items:center;gap:12px;padding:10px 14px;cursor:pointer;transition:.1s;border-bottom:1px solid #f5f5fb;"
                        ...
                        <input type="checkbox" name="members[]" value="{{ $user->id }}"
                               ...
                               style="width:15px;height:15px;accent-color:#4f6ef7;flex-shrink:0;">
                        <div style="width:32px;height:32px;border-radius:8px;background:linear-gradient(135deg,#4f6ef7,#7c3aed);display:flex;align-items:center;justify-content:center;font-size:11px;font-weight:700;color:#fff;flex-shrink:0;">
